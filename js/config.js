 ...
 */
 function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    .state('pages.empy_page', {
                ...
                userAuthenticated: ["$http", "$q", "$location", function($http, $q, $location) {
                    ...
                    firebase.auth().onAuthStateChanged(function(user) {
                        if (user) {
                            ...
                            $location.path("/stores/list_stores").replace().reload(true);
                            deferred.resolve();
        ...
        .state('stores.claimed', {
            url: "/claimed",
            templateUrl: "views/stores_claimed.html",
            data: {
                pageTitle: 'Claimed Data Tables'
            },
            resolve: {
                loadPlugin: function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('stores.list_stores', {
            url: "/list_stores",
            templateUrl: "views/stores_list_stores.html",
            data: {
                pageTitle: 'Store Data Tables'
            },
            resolve: {
                loadPlugin: function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('stores.add_store', {
            url: "/add_store",
            templateUrl: "views/stores_add_store.html",
            data: {
                pageTitle: 'Add form'
            },
            resolve: {
        ...
        .state('stores.edit_store', {
            url: "/edit",
            templateUrl: "views/stores_edit_store.html",
            data: {
                pageTitle: 'Edit form'
            },
            resolve: {
        ...
        .state('stores.list_store_types', {
            ...
            templateUrl: "views/stores_list_store_types.html",
            data: {
                pageTitle: 'Store Data Tables'
            },
            resolve: {
        ...
        .state('stores.add_store_type', {
            url: "/add_store_type",
            templateUrl: "views/stores_add_store_type.html",
            data: {
                pageTitle: 'Add form'
            },
            resolve: {
        ...
        .state('users.list_users', {
            url: "/list_users",
            templateUrl: "views/users_list_users.html",
            data: {
                pageTitle: 'Auditor Data Tables'
            },
            resolve: {
                loadPlugin: function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('users.add_user', {
            url: "/add_user",
            templateUrl: "views/users_add_user.html",
            data: {
                pageTitle: 'Add User'
            },
            resolve: {
        ...
        .state('users.edit_user', {
            url: "/edit",
            templateUrl: "views/users_edit_user.html",
            data: {
        ...
        .state('auditors.list_auditors', {
            url: "/list_auditors",
            templateUrl: "views/auditors_list_auditors.html",
            data: {
                pageTitle: 'Auditor Data Tables'
            },
            resolve: {
        ...
        .state('auditors.add_auditor', {
            url: "/add_auditor",
            templateUrl: "views/auditors_add_auditor.html",
            data: {
        ...
        .state('auditors.edit_auditors', {
            url: "/edit",
            templateUrl: "views/auditors_edit_auditor.html",
            data: {
                pageTitle: 'Edit Auditor'
            },
            resolve: {
        ...
        .state('displays.add_display_type', {
            ...
            templateUrl: "views/displays_add_display_type.html",
            data: {
                pageTitle: 'Add display form'
            },
            resolve: {
                loadPlugin: function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('displays.edit_display_type', {
            url: "/edit",
            templateUrl: "views/displays_edit_display_type.html",
            data: {
        ...
        .state('displays.list_rewards', {
            url: "/list_rewards",
            templateUrl: "views/displays_list_rewards.html",
            data: {
                pageTitle: 'Reward Data Tables'
            },
            resolve: {
                loadPlugin: function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('displays.add_reward', {
            url: "/add_rewards",
            templateUrl: "views/displays_add_reward.html",
            data: {
                pageTitle: 'Add Rewards Display'
            },
            resolve: {
                loadPlugin: function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('displays.edit_reward', {
            url: "/edit",
            templateUrl: "views/displays_edit_reward.html",
            data: {
                pageTitle: 'Edit Display'
            },
            resolve: {
