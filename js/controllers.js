...
function addUserCtrl($scope, $firebaseArray){
 ...
 */
 ...
 function listStoreTypesCtrl() {

 }

 function addStoreCtrl() {

 }

 function addStoreTypesCtrl() {

 }

 function listRewardsCtrl() {

 }

 function listDisplaysCtrl() {
...
function listDisplaysCtrl($scope,DTOptionsBuilder){
     ...
     */
     ...
     {
        id: '1',
        name: 'ចាំបាច់សម្រាប់តាំង / Must Set Display',
        point: 2000000,
        imgurl: 'd1.png',
        display_type: 'HPC GOLD'
    },
    {
        id: '2',
        name: 'តាំងលើធ្នើរ / Shelf Display',
        point: 3000000,
        imgurl: 'd2.png',
        display_type: 'HPC GOLD'
...
function rewardsCtrl($scope,DTOptionsBuilder){
...
.controller('addStoreTypesCtrl', addStoreTypesCtrl)
